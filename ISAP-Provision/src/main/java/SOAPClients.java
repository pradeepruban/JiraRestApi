...
public class SOAPClients 
{
	    ...
	    static final String PROJECT_KEY = "ISAP";
	    static final String NEW_SUMMARY = "MSO Issue reported for provision : " + new Date();
	    static final String PROJECT_NAME = "ISAP";
	    static final String PROJECT_DESCRIPTION ="Provisioning a VM"; 
	    static final String CREATE_PROJECT_KEY="ISAP"; 
	    static final String ISSUE_TYPE_ID = "2";
	    static final String SUMMARY_NAME = "PROVISIONING A VM";
	    static final String PRIORITY_ID ="1";
	    static final String COMPONENT_ID ="1";
	    static final String VERSION_ID ="1.0";
	  //  static final String CUSTOM_FIELD_KEY_1 ="1";
	  //  static final String CUSTOM_FIELD_KEY_2 ="2";
	  //  static final String CUSTOM_FIELD_VALUE_1 ="ISAP";
	   // static final String CUSTOM_FIELD_VALUE_2 ="ISAP-ISSUE1";
	    static final String NEW_COMMENT_BODY ="ISAP PROVISION VM";
	    static final String FILTER_ID ="1";
